...
function Register () {
    ...
    const submit = async (e) => {
        ...
        try{
            ...
            await axios.post("https://back-end-test-t.herokuapp.com/users/register", newUser);
            const loginResponse = await axios.post("https://back-end-test-t.herokuapp.com/users/login", {
                email, password
            });
            setUserData({
